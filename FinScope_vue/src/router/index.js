...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/news-detail', // Route for news detail, will use query param for URL
      name: 'news-detail',
      component: NewsDetail,
      // props: true, // props:true is for path parameters. We'll use useRoute().query in the component.
    },
  ],
})
