    ...
    <div class="bg-white p-8 rounded-lg shadow-xl w-full max-w-md border border-gray-200">
      ...
      <div class="mb-6 flex flex-col space-y-3">
        <button type="button" @click="handleGoogleLogin"
          class="w-full flex items-center justify-center p-3 border border-gray-400 rounded-lg hover:bg-gray-50 text-sm font-medium text-gray-700">
        ...
        <button type="button" @click="handleKakaoLogin"
          class="w-full flex items-center justify-center p-3 bg-[#FEE500] text-black rounded-lg hover:bg-yellow-400 text-sm font-medium border border-gray-300">
          <svg class="social-btn-svg" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <button type="button" @click="handleNaverLogin"
          class="w-full flex items-center justify-center p-3 bg-[#03C75A] text-white rounded-lg hover:bg-green-600 text-sm font-medium border border-gray-300">
      ...
      <form @submit.prevent="handleLoginSubmit">
        <div class="mb-4">
          ...
          <input type="text" id="loginUsername" v-model="username"
            class="w-full p-3 border border-gray-400 rounded-lg focus:ring-2 focus:ring-teal-500" required>
        </div>
        <div class="mb-6">
        ...
        <button type="submit"
          class="w-full bg-teal-600 text-white py-3 rounded-lg hover:bg-teal-700 font-semibold">로그인</button>
      </form>
