  ...
  <nav class="bg-gray-900 shadow-md sticky top-0 z-50">
    <div class="container mx-auto px-4 py-3 flex justify-between items-center">
      ...
      <div class="hidden md:flex flex-grow justify-center items-center space-x-1 lg:space-x-2 menu-bar">
        ...
        <RouterLink to="/stock-info" class="nav-link">주식 정보</RouterLink>
        <RouterLink to="/bank-map" class="nav-link">은행 찾기</RouterLink>
        <RouterLink to="/recommend-deposit" class="nav-link">추천 금융상품</RouterLink>
      ...
      <div class="hidden md:flex items-center space-x-3 ml-4"> 
        ...
        <RouterLink v-if="!isLoggedIn" to="/signup"
          class="border border-primary text-primary-light hover:bg-primary hover:text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-150">회원가입</RouterLink>
    ...
    <div :class="[isMobileMenuOpen ? 'block' : 'hidden', 'md:hidden', 'bg-gray-800 shadow-lg py-2']">
      ...
      <RouterLink to="/stock-info" @click="closeMobileMenu" class="mobile-nav-link">주식 정보</RouterLink>
      <RouterLink to="/bank-map" @click="closeMobileMenu" class="mobile-nav-link">은행 찾기</RouterLink>
      <RouterLink to="/recommend-deposit" @click="closeMobileMenu" class="mobile-nav-link">추천 금융상품</RouterLink>
