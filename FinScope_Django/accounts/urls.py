...
urlpatterns = [
    ...
    path("bookmark-video/", views.save_video_bookmark, name="save_video_bookmark"),
    path("save-ai-recommendation/", views.save_ai_recommendation, name="save_ai_recommendation"),
]
