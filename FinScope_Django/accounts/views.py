...
from .serializers import (
    ...
    FinancialProductSerializer, # Import FinancialProductSerializer
)
...
@api_view(["GET"])
@permission_classes([AllowAny]) # Or IsAuthenticated if login is required to see products
def list_financial_products(request):
    ...
    # Optional: Add ordering, e.g., by product name or disclosure date
    # queryset = queryset.order_by('fin_prdt_nm') 
